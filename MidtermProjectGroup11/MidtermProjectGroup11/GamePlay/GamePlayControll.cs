...
namespace MidtermProjectGroup11.GamePlay
{
    public class GamePlayControll
    {
        ...
        public GamePlayControll(Control parentCntl)
        {
            ...
            listPlayer.Add(null);
            listPlayer.Add(new Player("Player 1", (PictureBox)FormSupport.Instance.GetControlByName(parentCntl, "Player_1")));
            listPlayer.Add(new Player("Player 2", (PictureBox)FormSupport.Instance.GetControlByName(parentCntl, "Player_2")));
            listPlayer.Add(new Player("Player 3", (PictureBox)FormSupport.Instance.GetControlByName(parentCntl, "Player_3")));
            listPlayer.Add(new Player("Player 4", (PictureBox)FormSupport.Instance.GetControlByName(parentCntl, "Player_4")));
            ...
            while (CountAllHouseForCurrentPlayer() > 0)
            {
                ...
                foreach (var item in ListPiece)
                {
                    ...
                    if (item.Type == 1)
                    {
                        ...
                        {
                            bool answer = ListPlayer[CurrentPlayer].YesNoQuestion("You wanna to sell one house of this land for " + (item as Land).HouseMortgage, new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Monopoly", "Properties", ListPiece.IndexOf(item as Land) + ".png")));
                            if (answer == true)
                            {
            ...
            while (CountAllHotelForCurrentPlayer() > 0)
            {
                ...
                foreach (var item in ListPiece)
                {
                    ...
                    if (item.Type == 1)
                    {
                        ...
                        {
                            bool answer = ListPlayer[CurrentPlayer].YesNoQuestion("You wanna to sell hotel of this land for " + (item as Land).HotelMortgage, new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Monopoly", "Properties", ListPiece.IndexOf(item as Land) + ".png")));
                            if (answer == true)
                            {
            ...
            while (CountAllPieceForCurrentPlayer(1) > 0)
            {
                foreach (var item in ListPiece)
                {
                    ...
                    if (item.Type == 1)
                    {
                        if ((item as Land).OwnerPlayer == CurrentPlayer)
                        {
                            bool answer = ListPlayer[CurrentPlayer].YesNoQuestion("You wanna to sell this land for " + (item as Land).Mortgage, new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Monopoly", "Properties", ListPiece.IndexOf(item as Land) + ".png")));
                            if (answer == true)
                            {
            ...
            while (CountAllPieceForCurrentPlayer(3) > 0)
            {
                ...
                foreach (var item in ListPiece)
                {
                    ...
                    if (item.Type == 3)
                    {
                        ...
                        {
                            bool answer = ListPlayer[CurrentPlayer].YesNoQuestion("You wanna to sell this factory for " + (item as Factory).Mortgage, new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Monopoly", "Properties", ListPiece.IndexOf(item as Factory) + ".png")));
                            if (answer == true)
                            {
            ...
            {         
                foreach (var item in ListPiece)
                {
                    ...
                    if (item.Type == 2)
                    {
                        ...
                        {
                            bool answer = ListPlayer[CurrentPlayer].YesNoQuestion("You wanna to sell this station for " + (item as Station).Mortgage, new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Monopoly", "Properties", ListPiece.IndexOf(item as Station) + ".png")));
                            if (answer == true)
                            {
        ...
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(false, 1);
        ...
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(false, 2);
        ...
        {
            MessageBox.Show("Good luck at next Chest :))");
        }

        private void ChestCard4()
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(false, 4);
        ...
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(false, 5);
        ...
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(false, 6);
            int totalMoney = CheckMoneyToDoSomething();
            int costMustPay = 50;
            if (ListPlayer[CurrentPlayer].Money >= costMustPay)
            {
        ...
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(false, 7);
            int totalMoney = CheckMoneyToDoSomething();
            int costMustPay = 50;
            if (ListPlayer[CurrentPlayer].Money >= costMustPay)
            {
        ...
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(false, 8);
        ...
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(false, 9);
            int totalMoney = CheckMoneyToDoSomething();
        ...
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(false, 10);
            _form.TransMoneyFromBankToPlayer(100);
            ListPlayer[CurrentPlayer].Money += 100;
            _form.AllPlayerGraphicSet();
        }
        ...
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(true, 1);
        ...
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(true, 2);
        ...
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(true, 3);
        ...
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(true, 4);
        ...
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(true, 5);
            if (CurrentPlayer - 3 < 1)
            {
                ListPiece[40].Position.Controls.Add(ListPlayer[CurrentPlayer].PlayerToken);
                ListPlayer[CurrentPlayer].CurrentPosition =40;
            }
            else
            {
        ...
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(true, 6);
            ListPiece[41].Position.Controls.Add(ListPlayer[CurrentPlayer].PlayerToken);
            ListPlayer[CurrentPlayer].CurrentPosition = 41;
            ListPlayer[CurrentPlayer].RollCounter = 0;
        }
        ...
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(true, 7);
            int totalMoney = CheckMoneyToDoSomething();
        ...
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(true, 8);
            int totalMoney = CheckMoneyToDoSomething();
            int costMustPay = 15;
            if (ListPlayer[CurrentPlayer].Money >= costMustPay)
            {
        ...
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(true, 9);
            int totalMoney = CheckMoneyToDoSomething();
            int costMustPay = 150;
            if (ListPlayer[CurrentPlayer].Money >= costMustPay)
            {
        ...
        {
            ListPlayer[CurrentPlayer].YesNoQuestionChance(true, 10);
            _form.TransMoneyFromBankToPlayer(100);
            ListPlayer[CurrentPlayer].Money += 100;
        }
        #endregion
        ...
        private void ActionAtPiece(int currentPoint)
        {
            ...
            {
                case 0:
                    ListPlayer[CurrentPlayer].AttentionForSomethingElse(Path.Combine(Application.StartupPath, @"Images", "Extra", "Pleple.jpg"));
                    break;
                case 1:
        ...
        private void ActionInJail()
        {
            ...
            if (ListPlayer[CurrentPlayer].Money >= costMustPay)
            {
                bool answer = ListPlayer[CurrentPlayer].YesNoQuestion("Want to free with 500 ?", new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Extra", "break.jpg")));
                if (answer)
                {
        ...
        {
            ListPlayer[CurrentPlayer].AttentionForSomethingElse(Path.Combine(Application.StartupPath, @"Images", "Extra", "tele.jpg"));
        ...
        private void ActionOnFactory(int currentPoint)
        {
            ...
            {
                // Gạ mua
                Bitmap thisPiece = new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Monopoly", "Properties", currentPoint + ".png"));
                bool answer = ListPlayer[CurrentPlayer].YesNoQuestion("Want to buy this Place ?", thisPiece);
                if (answer == true)
                {
                    ...
                    {
                        bool sellPieceAnswer = ListPlayer[CurrentPlayer].YesNoQuestion("Want to mortage some house, hotel, land,... to Buy it?", new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Extra", "break.png")));
                        if (sellPieceAnswer == true)
                        {
                            ...
                            {
                                ListPlayer[CurrentPlayer].YesNoQuestion("Có mua thì mới có ăn, không đủ tiền mua mà muốn ăn thì ... =))", new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Monopoly", "Extra", "Pleple.jpg")));
                            }
                        }
                    }
                    return;
        ...
        private void ActionOnFactoryForChance(int currentPoint, int xFee)
        {
            ...
            {
                // Gạ mua
                bool answer = ListPlayer[CurrentPlayer].YesNoQuestion("Want to buy this Place ?", new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Monopoly", "Properties", currentPoint + ".png")));
                if (answer == true)
                {
                    if (ListPlayer[CurrentPlayer].Money >= (ListPiece[currentPoint] as Factory).Price)
                    {
                    ...
                    {
                        bool sellPieceAnswer = ListPlayer[CurrentPlayer].YesNoQuestion("Want to mortage some house, hotel, land,... to Buy it?", new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Extra", "break.jpg")));
                        if (sellPieceAnswer == true)
                        {
                            if (totalMoney >= (ListPiece[currentPoint] as Factory).Price)
                            {
                            ...
                            {
                                ListPlayer[CurrentPlayer].YesNoQuestion("Có mua thì mới có ăn, không đủ tiền mua mà muốn ăn thì ... =))", new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Extra", "Pleple.jpg")));
                            }
                        }
                    }
                    return;
        ...
        private void ActionOnLand(int currentPoint)
        {
                ...
                if (answer == true)
                {
                    ...
                    else
                    {
                        ...
                        if (sellPieceAnswer == true)
                        {
                            ...
                            {
                                ListPlayer[CurrentPlayer].YesNoQuestion("Có mua thì mới có ăn, không đủ tiền mua mà muốn ăn thì ... =))", new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Extra", "break.jpg")));
                            }
                        }
                    }
                    return;
            ...
            else if ((ListPiece[currentPoint] as Land).OwnerPlayer == CurrentPlayer)
            {
                ...
                {
                    // Gạ mua
                    bool answer = ListPlayer[CurrentPlayer].YesNoQuestion("Want to buy house for this Place ?", new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Monopoly", "Properties", currentPoint + ".png")));
                    if (answer == true)
                    {
                ...
                {
                    // Gạ mua
                    bool answer = ListPlayer[CurrentPlayer].YesNoQuestion("Want to buy hotel for this Place ?", new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Monopoly", "Properties", currentPoint + ".png")));
                    if (answer == true)
                    {
                        ...
                        {
                            bool sellPieceAnswer = ListPlayer[CurrentPlayer].YesNoQuestion("Want to mortage some house, hotel, land,... to Buy it?", new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Monopoly", "Properties", currentPoint + ".png")));
                            if (sellPieceAnswer == true)
                            {
        ...
        RollAgain:
            ...
            if (endAt == 41 || diceResult == null)
            {
                ...
                {
                    Task sleepTask1 = new Task(Sleep);
                    sleepTask1.Start();
                    sleepTask1.Wait();
                ...
                sleepTask.Start();
                sleepTask.Wait();
                ListPlayer[CurrentPlayer].AttentionForSomethingElse(Path.Combine(Application.StartupPath, @"Images", "Extra", "fbi.png"));
                ListPiece[41].Position.Controls.Add(ListPlayer[CurrentPlayer].PlayerToken);
                ListPlayer[CurrentPlayer].RollCounter = 0;
            ...
            else if (endAt > 0)
            {
                ...
                if (getSalary)
                    ListPlayer[CurrentPlayer].AttentionForSomethingElse(Path.Combine(Application.StartupPath, @"Images", "Extra", "gift.jpg"));
            ...
            else if (diceResult != null)
            {
                ...
                {
                    bool questionResult = _listPlayer[CurrentPlayer].YesNoQuestion("Do you want to use break card?", new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Extra", "break.jpg")));
                    ...
                    {
                        bool questionResult1 = _listPlayer[CurrentPlayer].YesNoQuestion("Do you want to free by Pay 500?", new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Extra", "break.jpg")));
                ...
                {
                    bool questionResult = _listPlayer[CurrentPlayer].YesNoQuestion("Do you want to free by Pay 500?", new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Extra", "break.jpg")));
                    if (questionResult == true)
                    {
                        _listPlayer[CurrentPlayer].PayForFree();
                        _form.TransMoneyToBank(500);
                ...
                {
                    _listPlayer[CurrentPlayer].YesNoQuestion("You don't have enough money to get free", new Bitmap(Path.Combine(Application.StartupPath, @"Images", "Extra", "Pleple.jpg")));
                }
            }
        ...
        {
            ListPlayer[CurrentPlayer].EndYesYesQuestion();
        }
        ...
        #region Buying Graphic
        public void BuyLandGraphic(int position)
        {
            switch (CurrentPlayer)
            {
                case 1:
                    (ListPiece[position] as Land).Owner.BackgroundImage = new Bitmap(Path.Combine(Application.StartupPath, @"Images", "House", "blueOwner.png"));
                    break;
                case 2:
                    (ListPiece[position] as Land).Owner.BackgroundImage = new Bitmap(Path.Combine(Application.StartupPath, @"Images", "House", "redOwner.png"));
                    break;
                case 3:
                    (ListPiece[position] as Land).Owner.BackgroundImage = new Bitmap(Path.Combine(Application.StartupPath, @"Images", "House", "yellowOwner.png"));
                    break;
                default:
                    (ListPiece[position] as Land).Owner.BackgroundImage = new Bitmap(Path.Combine(Application.StartupPath, @"Images", "House", "whiteOwner.png"));
                    break;
            }
        ...
        public void BuyStationGraphic(int position)
        {
            ...
            {
                case 1:
                    (ListPiece[position] as Station).Owner.BackgroundImage = new Bitmap(Path.Combine(Application.StartupPath, @"Images", "House", "blueOwner.png"));
                    break;
                case 2:
                    (ListPiece[position] as Station).Owner.BackgroundImage = new Bitmap(Path.Combine(Application.StartupPath, @"Images", "House", "redOwner.png"));
                    break;
                case 3:
                    (ListPiece[position] as Station).Owner.BackgroundImage = new Bitmap(Path.Combine(Application.StartupPath, @"Images", "House", "yellowOwner.png"));
                    break;
                default:
                    (ListPiece[position] as Station).Owner.BackgroundImage = new Bitmap(Path.Combine(Application.StartupPath, @"Images", "House", "whiteOwner.png"));
                    break;
            }
        }
        public void BuyFactoryGraphic(int position)
        {
            ...
            {
                case 1:
                    (ListPiece[position] as Factory).Owner.BackgroundImage = new Bitmap(Path.Combine(Application.StartupPath, @"Images", "House", "blueOwner.png"));
                    break;
                case 2:
                    (ListPiece[position] as Factory).Owner.BackgroundImage = new Bitmap(Path.Combine(Application.StartupPath, @"Images", "House", "redOwner.png"));
                    break;
                case 3:
                    (ListPiece[position] as Factory).Owner.BackgroundImage = new Bitmap(Path.Combine(Application.StartupPath, @"Images", "House", "yellowOwner.png"));
                    break;
                default:
                    (ListPiece[position] as Factory).Owner.BackgroundImage = new Bitmap(Path.Combine(Application.StartupPath, @"Images", "House", "whiteOwner.png"));
                    break;
            }
        }
